 ...
 * 지정(우회 (2))·**유한성**(verifier F-1, 아래)·norm 이 `1 ± embedding.norm.epsilon` 안
 * (2E `isAcceptableEmbedding` 관례, `EmbeddingContractTest`가 test 쪽에서 이미 고정한
 * 규칙)·release 다섯 성분 비공백(우회 (6))을 모두 통과해야 `EmbeddingVector`·
