...
## 6b. 승인 결과 — 2026-09-08 (개찰 축)

**P-9 · P-10 · P-12 가 승인됐다** — 요청 표는 `_workspace/m3-3b2/01_curator_approval_request.md`,
...
| **P-8** | **첨부 URL 필드 계약**(`ntceSpecDocUrl1` 계열) 표 추가 | 3C `commands.md` 알려진 제한 · `OPEN-3C-ATTACHMENT-FIELD-CONTRACT` | **대기** — M4 4B 착수 전(3B-2 대상 아님) |
