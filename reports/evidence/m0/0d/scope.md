...
head_sha: f300674   # 이 갱신 커밋의 직전 커밋. 「head_sha와 range」 절 참조
in_scope:
...
| 이 커밋 | **R3-F3.** 위 `779266f` 행이 C-8과 `checklist.md` §9를 *"둘 다 되돌렸다"*로 묶었으나 **두 처리가 다르다** — 갈라 적었다. `head_sha`를 `f300674`로 옮긴다 |
