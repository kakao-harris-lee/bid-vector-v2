...
in_scope:
  ...
  # (⑤ 의 착수 경로 `adapters/persistence/JdbcCompetitionSampleSource.kt`·`Sql.kt` 는 갱신 이력 ②③ 으로 폐기 — 실제 경로는 아래 `adapters/ml/JdbcCompetitionSampleSource.kt`, `Sql.kt` 순변경 0. verifier r2 LOW: 죽은 항목 제거)
