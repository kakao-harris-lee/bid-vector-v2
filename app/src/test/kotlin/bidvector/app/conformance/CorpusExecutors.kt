 ...
 * 합친다. koneps-collection 은 27 case 중 20건만 담는다(`KonepsCollectionExecutors.kt` +
 * `KonepsCollectionAccountingExecutors.kt` 둘로 나뉜다, 500줄 한도가 아니라 관심사 분리) —
 * `KONEPS_COLLECTION_PENDING_CAPABILITY`(3A 잔여 일괄 ②)가 나머지 7건의 예외를 진다.
 */
